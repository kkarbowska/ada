...
**Dla danych z pliku "ankieta.csv" korzystając z funkcji z zadania 8., przyjmując 1 − α = 0.95, zweryfikuj następujęce hipotezy i sformułuj wnioski:**

### 1. Prawdopodobieństwo, że w firmie pracuje kobieta wynosi 0.5.

Wykonamy binom test prawdopodobieństwa sukcesu. Hipoteza zerowa zakłada, że prawdobodobieństwo, że w firmie pracuje kobieta wynosi 0.5, natomiast hipoteza alternatywna jest zaprzeczeniem hipotezy zerowej. Przyjmujemy poziom ufności 0.95. Zweryfikowaliśmy przedziały ufności i p-wartość by ocenić prawdziwość hipotezy zerowej. Wyniki są widoczne poniżej.
